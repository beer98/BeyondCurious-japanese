...
```bash
pip install -r apps/bottleneck-hunter/requirements.txt
export DEEPSEEK_API_KEY=sk-...

python apps/bottleneck-hunter/run_scan.py loop                          # 完整 4 阶段（推荐）
python apps/bottleneck-hunter/run_scan.py daily                         # 只 Phase C
python apps/bottleneck-hunter/run_scan.py review                        # 只 Phase A+B
python apps/bottleneck-hunter/run_scan.py critic --file 2026-04-30.md   # 只 Phase D
```
...
GitHub Actions cron (工作日 07:30 ET)
        ↓
apps/bottleneck-hunter/run_scan.py loop
        ↓
